...
public class CertificateNoUtil {
    ...
    //1.身份证信息查询
    public static void cardInfoQuery(String cardId){
        String result =null;
        String url ="http://apis.juhe.cn/idcard/index";//请求接口地址
        Map params = new HashMap();//请求参数
        params.put("cardno",cardId);//身份证号码
    ...
    //2.身份证泄漏查询
    public static void cardLeakQuery(String cardId){
        String result =null;
    ...
    //3.身份证挂失查询
    public static void cardReportQuery(String cardId){
        String result =null;
