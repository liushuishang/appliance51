...
//            inReader.close();
    ...
    public String doGetForString(String url, List<Header> headerList) throws URISyntaxException, ClientProtocolException, IOException {
        HttpResponse response = this.doGet(url, null, headerList);
    ...
    public <T> T doGetForClass(String url, Map<String, String> queryParams, List<Header> headerList,Class<T> clazz) throws IOException, URISyntaxException {
    ...
    public Map<String, Object> doGetForMap(String url, Map<String, String> queryParams, List<Header> headerList) throws IOException, URISyntaxException {
        return (Map<String, Object>)doGetForClass(url, queryParams, headerList, Map.class);
    }

    public Map<String, Object> doPostForMap(String url, Map<String, String> queryParams, List<Header> headerList) throws IOException, URISyntaxException {
